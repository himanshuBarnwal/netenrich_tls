...
from src.queries.query import  url_query
...
class URL:
    ...
    def processIOC(self,ioc):
        ...
        try:
            ans = {
                "malware_c2":[], "exploitkit": [], "c2_server": [], "attack_vector": [], "type": "url"
            }
            ...
            return {"Error Occured in getQueryInformation function : ": str(e)}
