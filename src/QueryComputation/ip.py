...
from src.queries.query import  ip_query
...
class IP:
    ...
    def processIOC(self,ioc):
        ...
        try:
            ans = {
                "urls":[],"fqdns":[], "threatactors":[],"campaigns":[],"hashes":[],"malwares":[],"honeypots": [],
                "malware_c2": [],"exploitkit": [],"c2_server": [],"attack_vector": [], "type": "ip"
            }
