...
from src.queries.query import th_query


class Threatactor:
    def __init__(self):
        self.__bq_handler = BigQueryHandler()
        self.ioc_type = 'threatactor'
    ...
    def processIOC(self,ioc):
        ...
        try:
            ans = {
                "fqdns":[], "ips":[], "urls":[],"geos":[],"identities":[],"industries":[],"vulns":[],"attack_patterns":[],
                "hashes":[],"malwares":[],"campaigns":[],"honeypots": [],"malware_c2": [],"exploitkit": [],
                "c2_server": [],"attack_vector": [], "type": "threatactor"
                }
            sql_query = th_query
