...
from src.queries.query import  hash_query
...
class Hash:
    ...
    def processIOC(self,ioc):
        ...
        try:
            ans = {
                "urls":[],"fqdns":[], "ips":[], "threatactors":[],"campaigns":[],"vulns":[],"malwares":[],
                "honeypots": [],"malware_c2": [],"exploitkit": [],"c2_server": [],"attack_vector": [], "type": "hash"
            }

            sql_query = hash_query
